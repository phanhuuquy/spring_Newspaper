        ...
        var FixedColumns = /** @class */ (function () {
            function FixedColumns(settings, opts) {
                ...
                if (
                    ...
                    !dataTable.versionCheck("1.10.0")
                ) {
                    throw new Error(
                        "FixedColumns requires DataTables 1.10 or newer"
                    );
                }
            ...
            FixedColumns.prototype._addStyles = function () {
                ...
                if (this.s.dt.settings()[0].oScroll.sY) {
                    var scroll_1 = $$1(this.s.dt.table().node()).closest(
                        "div.dataTables_scrollBody"
                    )[0];
                    var barWidth = this.s.dt.settings()[0].oBrowser.barWidth;
                    if (
                        scroll_1.offsetWidth - scroll_1.clientWidth >=
                        barWidth
                    ) {
                ...
                if (header !== null) {
                    ...
                    parentDiv = $$1(
                        header.closest("div.dataTables_scroll")
                ...
                if (footer !== null) {
                    ...
                    if (parentDiv === null) {
                        parentDiv = $$1(
                            footer.closest("div.dataTables_scroll")
                        ).css("position", "relative");
                    }
                }
                ...
                var rows = $$1(this.s.dt.table().node())
                    .children("tbody")
                    .children("tr");
                var invisibles = 0;
                ...
                for (var i = 0; i < numCols; i++) {
                    ...
                    if (i - invisibles < this.c.left) {
                        $$1(this.s.dt.table().node()).addClass(
                        ...
                        if (i - invisibles > 0) {
                            ...
                            while (prevIdx + 1 < numCols) {
                                var prevCol = this.s.dt.column(prevIdx - 1, {
                                    page: "current",
                                });
                                if (prevCol.visible()) {
                                    distLeft += $$1(
                    ...
                    if (i + rightInvisibles >= numCols - this.c.right) {
                        ...
                        for (
                            ...
                            $$1($$1(row).children()[i - prev])
                                .css(
                                    this._getCellCSS(false, distRight, "right")
                                )
            ...
            FixedColumns.prototype._getCellCSS = function (header, dist, lr) {
                if (lr === "left") {
                    ...
                    return this.s.rtl
                        ? {
                              left:
                                  dist + (header ? this.s.barWidth : 0) + "px",
                              position: "sticky",
                          }
                        : {
                              position: "sticky",
            ...
            FixedColumns.prototype._setKeyTableListener = function () {
                ...
                this.s.dt.on("key-focus.dt.dtfc", function (e, dt, cell) {
                    ...
                    var scroll = $$1(
                        $$1(_this.s.dt.table().node()).closest(
                            "div.dataTables_scrollBody"
                        )
                    );
                    ...
                    if (_this.c.left > 0) {
                        ...
                        var rightMost = $$1(
                            _this.s.dt.column(_this.c.left - 1).header()
                        );
                    ...
                    if (_this.c.right > 0) {
                        ...
                        var leftMost = $$1(
                            _this.s.dt.column(numCols - _this.c.right).header()
                        );
                ...
                this.s.dt.on(
                    ...
                    function (e, settings, column, state, recalc) {
